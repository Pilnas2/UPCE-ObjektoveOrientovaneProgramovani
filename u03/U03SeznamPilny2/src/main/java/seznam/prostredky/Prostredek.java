...
//        return String.format("typ=, SPZ=, hmotnost=%4.2f",
//                typ.nazev(), spz, hmotnost);
//    }
    @Override
    public String toString() {
        return "typ=" + typ.nazev() + ", SPZ=" + spz + ", hmotnost=" + String.format(Locale.ENGLISH, "%4.2f", hmotnost);
    }
...
//        }
    ...
    public Prostredek clone() throws CloneNotSupportedException {
        return (Prostredek) super.clone(); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
